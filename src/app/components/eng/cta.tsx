        ...
        <div className="flex flex-col items-center gap-10 sm:gap-12 lg:gap-16">
          ...
          <div className="flex flex-col items-center gap-6 sm:gap-8">
            ...
            <h2 className="font-garamond text-3xl sm:text-4xl lg:text-5xl xl:text-6xl font-bold uppercase text-white leading-tight max-w-4xl">
              ...
              <span className="text-[#EFC9A5]">COZY CAFÉ?</span>
            </h2>
          </div>
          ...
          <div className="flex flex-col items-center gap-8 sm:gap-10">
            ...
            <p className="font-crimson text-base sm:text-lg lg:text-xl text-white/80 leading-relaxed max-w-3xl">
              Feel free to contact us with questions about our fresh dishes,
              opening hours, or special requests. G. Karin Freiler and our
              friendly team are happy to help!
            </p>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 w-full max-w-5xl mt-6">
              ...
              <div className="text-center lg:text-left">
                ...
                <div className="font-crimson text-white/90 space-y-2">
                  ...
                  <p className="text-base lg:text-lg">1010 Vienna</p>
              ...
              <div className="text-center lg:text-left">
                ...
                <div className="font-crimson text-white/90 space-y-3">
                  <div>
                    ...
                    <p className="text-sm lg:text-base">10:00 AM - 10:00 PM</p>
                    <p className="text-xs lg:text-sm text-white/70">
                      (Kitchen: 11:00 AM - 9:00 PM)
                    </p>
                  </div>
                  <div>
                    <p className="text-base lg:text-lg font-semibold">
                    ...
                    <p className="text-sm lg:text-base">1:00 PM - 10:00 PM</p>
                    <p className="text-xs lg:text-sm text-white/70">
                      (Kitchen: 1:00 PM - 9:00 PM)
                    </p>
                  </div>
                  <div>
                    ...
                    <p className="text-sm lg:text-base text-white/60">Closed</p>
                  </div>
                </div>
              </div>
            </div>
