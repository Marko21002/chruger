    ...
    <div>
      <div className="w-full h-[95vh] bg-[#04242C] relative">
        ...
        <Image
          ...
          width={400}
          height={400}
          className="z-10 absolute bottom-[-10%] left-1/2 -translate-x-1/2 w-9/12 max-w-[400px] h-auto"
        />
        <div className="relative z-20 flex flex-col items-center gap-8 justify-center px-12 pt-24 pb-56 sm:pb-64 lg:pb-72">
